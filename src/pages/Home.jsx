  ...
  return (
    <div className='my-20 w-4/5 mx-auto'>
      ...
      <div className='mt-16 grid grid-cols-1 gap-8 lg:grid-cols-3 md:grid-cols-2'>
        {
          data.map(show => <div className="card w-80 bg-base-200 shadow-xl" key={show.score}>
          ...
          <div className="card-body">
            ...
            <span className='font-semibold'>Genres:</span> {show.show.genres.map(type => <h1 key={type}>{type}</h1>)}
            </h1>
